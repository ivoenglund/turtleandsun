...
const BTN = 'display:inline-block;background:#097f0b;color:#FFE800;text-decoration:none;font-weight:700;padding:12px 22px;border-radius:10px;border:2px solid #000000;-webkit-print-color-adjust:exact;print-color-adjust:exact';
const BTNCLS = 'ts-btn';
