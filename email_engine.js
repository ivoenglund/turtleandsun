...
function wrap(title, inner) {
  return '<!doctype html><html style="min-height:100%;-webkit-print-color-adjust:exact;print-color-adjust:exact"><head><style>*{-webkit-print-color-adjust:exact;print-color-adjust:exact}@media print{.ts-btn{color:#000000!important}}</style></head>' +
...
const BTN = 'display:inline-block;background:#81C784;color:#000000;text-decoration:none;font-weight:700;padding:12px 22px;border-radius:10px;border:2px solid #000000;-webkit-print-color-adjust:exact;print-color-adjust:exact';
const BTNCLS = 'ts-btn';
