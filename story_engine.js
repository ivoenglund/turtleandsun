...
function buildPostingKitPrompt({ story, situationText, ctaCard, links }) {
  return [
    ...
    '',
    'THE KEY SELLING POINT — work it into every text where space allows:',
    'you connect the contacts in your phone and every birthday lands on the',
    'calendar AUTOMATICALLY — no typing, no filling in dates. State it plainly,',
    'e.g. "your phone contacts become the calendar — birthdays fill in themselves".',
    '',
    'STYLE: no fluff. Cut filler adjectives ("stunning", "beautiful", "amazing")',
    'and generic marketing lines. Every text = one concrete benefit + the offer',
    '+ where to go. Short sentences. Sound like a person, not a brand.',
    '',
